...
input_data = st.text_input("Block Data", key="text")
...
input_sender = st.text_input("Enter the sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_receiver = st.text_input("Enter the receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_amount = st.text_input("Enter the amount")
